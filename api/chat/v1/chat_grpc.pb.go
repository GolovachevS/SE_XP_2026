...
func (c *chatServiceClient) ChatStream(ctx context.Context, opts ...grpc.CallOption) (ChatService_ChatStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &ChatService_ServiceDesc.Streams[0], "/chat.v1.ChatService/ChatStream", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *chatServiceChatStreamClient) Send(m *Envelope) error {
	return x.ClientStream.SendMsg(m)
}

func (x *chatServiceChatStreamClient) Recv() (*Envelope, error) {
	m := new(Envelope)
...
func (x *chatServiceChatStreamServer) Send(m *Envelope) error {
	return x.ServerStream.SendMsg(m)
}

func (x *chatServiceChatStreamServer) Recv() (*Envelope, error) {
	m := new(Envelope)
